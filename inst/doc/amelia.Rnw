...
\begin{figure}[ht]
  \centering 
    \includegraphics[scale=1]{splash.png}
...
\begin{figure}[ht]
  \centering 
    \includegraphics[scale=1]{import.png}
...
\begin{figure}[ht]
  \centering
    \includegraphics[scale=1]{context-menu.png}
...
\item \textbf{Set as Time-Series Variable} - Sets the currently
  ...
  and leads and add splines of time.
\item \textbf{Set as Cross-Section Variable} - Sets the currently
  ...
  the splines of time with the cross-section. 
...
\begin{figure}[h]
  \centering 
    \includegraphics[scale=1]{numopts.png}
  \caption{Options menu.}
  \label{f:numopts}
\end{figure}
\begin{enumerate}
...
\begin{figure}[ht]
  \centering 
    \includegraphics[scale=1]{output-log.png}
...
\begin{figure}[ht]
  \centering
    \includegraphics[scale=1]{diag.png}
