...
Running the same model with imputed data is almost identical. Simply replace the original data set with the `amelia()` output:


```{r zelig_run_imp, echo = FALSE}
if (requireNamespace("Zelig", quietly = TRUE)) {
