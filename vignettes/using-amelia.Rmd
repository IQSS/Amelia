...
[^freetrade]: We have artificially addedsome missingness to these data for presentational purposes. You can access the original data at
  [http://www.princeton.edu/~hmilner/Research.htm]().
...
### Ridge priors for high missingness, Small samples, or large correlations {#sec:prior}
...
This new imputation model is much more stable and, as shown by using `tscsPlot()`, produces about the same imputations as the original model:
